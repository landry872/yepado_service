    ...
    <section id="a-propos" data-pad="" style={css("position:relative;padding:130px 40px;background:#FAFAF8;scroll-margin-top:90px")}>
      <div style={css("max-width:1560px;margin:0 auto;position:relative")}>
        <div data-reveal="" style={css("opacity:0;transform:translateY(30px);transition:opacity .8s cubic-bezier(.22,1,.36,1),transform .8s cubic-bezier(.22,1,.36,1);max-width:820px;margin-bottom:20px")}>
          ...
          <h2 style={css("font-family:'Space Grotesk',sans-serif;font-weight:500;font-size:clamp(38px,4.4vw,60px);line-height:0.88;letter-spacing:-4.6px;margin:0;color:#1A1A1A")}>Un interlocuteur local unique,<br />au service de vos <span style={{ color: '#32348A' }}>ambitions africaines.</span></h2>
        ...
        <div data-stack="" style={css("display:grid;grid-template-columns:300px 1fr;gap:60px;align-items:start;margin-top:60px")}>
          <div style={css("position:sticky;top:120px;align-self:start")}>
          ...
          <div style={css("display:flex;flex-direction:column;gap:clamp(70px,9vh,120px);padding-bottom:20px")}>
            <div id="mission" data-reveal="" style={css("opacity:0;transform:translateY(34px);transition:opacity .85s cubic-bezier(.22,1,.36,1),transform .85s cubic-bezier(.22,1,.36,1);scroll-margin-top:120px")}>
              <div style={css("margin-bottom:22px")}><h3 style={css("font-family:'Space Grotesk','Just Sans',sans-serif;font-size:clamp(30px,3.4vw,44px);font-weight:600;color:#1A1A1A;margin:0;letter-spacing:-3px;line-height:0.9")}>Mission</h3></div>
            ...
            <div id="vision" data-reveal="" style={css("opacity:0;transform:translateY(34px);transition:opacity .85s cubic-bezier(.22,1,.36,1),transform .85s cubic-bezier(.22,1,.36,1);scroll-margin-top:120px")}>
              <div style={css("margin-bottom:22px")}><h3 style={css("font-family:'Space Grotesk','Just Sans',sans-serif;font-size:clamp(30px,3.4vw,44px);font-weight:600;color:#1A1A1A;margin:0;letter-spacing:-3px;line-height:1.05")}>Vision</h3></div>
            ...
            <div id="valeurs" data-reveal="" style={css("opacity:0;transform:translateY(34px);transition:opacity .85s cubic-bezier(.22,1,.36,1),transform .85s cubic-bezier(.22,1,.36,1);scroll-margin-top:120px")}>
              <div style={css("margin-bottom:22px")}><h3 style={css("font-family:'Space Grotesk','Just Sans',sans-serif;font-size:clamp(30px,3.4vw,44px);font-weight:600;color:#1A1A1A;margin:0;letter-spacing:-3px;line-height:1.05")}>Nos valeurs</h3></div>
              <div style={css("margin-top:14px;border-top:1px solid rgba(50,52,138,.14)")}>
                {VALEURS.map((v) => (
                  <div key={v.num} className="yn-valeur-row" data-reveal="" style={css("opacity:0;transform:translateY(34px);transition:opacity .85s cubic-bezier(.22,1,.36,1),transform .85s cubic-bezier(.22,1,.36,1),background .3s,padding-left .3s;display:flex;gap:24px;align-items:baseline;padding:26px 10px;border-bottom:1px solid rgba(50,52,138,.14)")}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={css("font-family:'Space Grotesk','Just Sans',sans-serif;font-size:20px;font-weight:600;color:#1A1A1A;margin-bottom:7px;letter-spacing:-1.4px")}>{v.title}</div>
                      <div style={css("font-size:14px;line-height:1.65;color:#6B6B7E;max-width:560px")}>{v.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div id="chiffres" data-reveal="" style={css("opacity:0;transform:translateY(34px);transition:opacity .85s cubic-bezier(.22,1,.36,1),transform .85s cubic-bezier(.22,1,.36,1);scroll-margin-top:120px")}>
              <div style={css("margin-bottom:22px")}><h3 style={css("font-family:'Space Grotesk','Just Sans',sans-serif;font-size:clamp(30px,3.4vw,44px);font-weight:600;color:#1A1A1A;margin:0;letter-spacing:-3px;line-height:1.05")}>Chiffres clés</h3></div>
              <div data-chiffres="" style={css("display:grid;grid-template-columns:repeat(4,1fr);gap:0;margin-top:18px;border-top:1px solid rgba(50,52,138,.16);padding-top:34px")}>
                {CHIFFRES.map((c, i) => (
                  <div key={i} data-reveal="" style={{
                    ...
                    <div style={css("font-size:18px;color:#6B6B7E;margin-top:12px;letter-spacing:.3px;line-height:1.4")}>{c.label}</div>
                  </div>
                ))}
              </div>
            </div>
