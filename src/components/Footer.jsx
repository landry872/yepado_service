        ...
        <div data-footer-grid="" style={css("display:grid;grid-template-columns:2fr 1fr 1fr;gap:50px;padding-bottom:56px;border-bottom:1px solid rgba(255,255,255,.1)")}>
          <div>
            ...
            <div style={css("display:flex;gap:11px;margin-top:24px")}>
              <a href="#accueil" data-nav="#accueil" className="yn-social" aria-label="LinkedIn" style={css("width:40px;height:40px;border-radius:11px;border:1px solid rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;color:rgba(250,250,248,.7)")}><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.02 8.5h4.96V24H.02V8.5zM8 8.5h4.76v2.12h.07c.66-1.25 2.28-2.56 4.7-2.56 5.02 0 5.95 3.3 5.95 7.6V24h-4.96v-6.84c0-1.63-.03-3.72-2.27-3.72-2.27 0-2.62 1.77-2.62 3.6V24H8V8.5z"></path></svg></a>
              <a href="#accueil" data-nav="#accueil" className="yn-social" aria-label="Facebook" style={css("width:40px;height:40px;border-radius:11px;border:1px solid rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;color:rgba(250,250,248,.7)")}><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.89 3.77-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99A10 10 0 0 0 22 12z"></path></svg></a>
              <a href="mailto:contact@yepado-service.com" className="yn-social" aria-label="Email" style={css("width:40px;height:40px;border-radius:11px;border:1px solid rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;color:rgba(250,250,248,.7)")}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"></rect><path d="m22 7-10 5L2 7"></path></svg></a>
            </div>
          </div>
          <div>
